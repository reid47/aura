...
//   toDOM = () => {
//     this.settings = el('div.Aura-settings', {
//       hidden: true
//     });

//     this.settingsDialog = el('div.Aura-settings-dialog', {
//       role: 'dialog',
//       tabindex: '0',
//       'aria-label': 'editor settings'
//     });

//     this.settingsCloseButton = el('button.Aura-settings-close-button', {
//       type: 'button',
//       'aria-label': 'close'
//     });

//     this.settingsCloseButton.innerHTML = '&times;';

//     this.settingsInputs = configurableSettings.map(setting => {
//       const label = el('label.Aura-settings-input-label');
//       label.innerText = setting.label;
